...
//zz
extern ssize_t synaptics_info_read_proc(struct file *file, char __user * page, size_t size, loff_t * ppos);
extern ssize_t synaptics_info_write_proc(struct file *file, const char *buffer, size_t count, loff_t * ppos);

extern int  getConfigId(char *buf);
//zz
#endif
