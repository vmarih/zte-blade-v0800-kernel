...
#define FTS_VENDOR_ID_CHUANGWEI 0x15
#define FTS_VENDOR_ID_HELITAI   0x82
...
//upgrade functions
extern void fts_update_fw_vendor_id(struct i2c_client *client/*fts_ts_data *data*/);
...
//zz
extern ssize_t FtsTouchscreenInfoRead(struct file *pFile, char __user *pBuffer, size_t nCount, loff_t *pPos);
//zz
/*******************************************************************************
