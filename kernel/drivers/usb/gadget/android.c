					...
					struct usb_composite_dev *cdev)
{
	...
	m_config.nluns = 2;
        m_config.luns[0].removable = true;
	m_config.luns[0].ro = 0;
	m_config.luns[0].cdrom = 0;
	m_config.luns[0].filename = NULL;

        m_config.luns[1].removable = true;
	m_config.luns[1].ro = 1;
	m_config.luns[1].cdrom = 1;
	m_config.luns[1].filename = NULL;
	
	m_config.vendor_name = NULL;
	m_config.product_name = NULL;

	m_config.ops = NULL;
	m_config.private_data = NULL;

	/* Finalise */
	m_config.can_stall = 0;
	m_config.fsg_num_buffers = fsg_num_buffers;	
