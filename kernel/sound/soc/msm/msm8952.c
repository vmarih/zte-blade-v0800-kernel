...
#include "../codecs/aw87319.h" /* lll054850 add for aw87319 20161128*/
...
#ifdef CONFIG_ZFG_AW87319_PA
	const char *aw87319_pa = "awinic,ext_pa_spk_aw87319_rst";
#else
...
#ifdef CONFIG_ZFG_AW87319_PA
		dev_dbg(&pdev->dev,
			"%s: lll054850 missing %s in dt node\n", __func__, aw87319_pa);
#else
        dev_dbg(&pdev->dev,
...
/* lll054850 add for aw87319 20161128*/
#if defined CONFIG_ZFG_AW87319_PA
    if (!gpio_is_valid(pdata->spk_ext_pa_gpio)) {
...
#elif defined CONFIG_ZFG_AW8736_PA 
...
static struct snd_soc_dai_link msm8952_dai[] = {
	...
	{ /* hw:x,25 */
		...
		.ignore_pmdown_time = 1,
		.codec_dai_name = "tfa98xx-aif-2-34",//.codec_dai_name = "snd-soc-dummy-dai",
		.codec_name = "tfa98xx.2-0034",     //.codec_name = "snd-soc-dummy",
	},
#else
	{ /* hw:x,25 */
...
/* lll054850 add for aw87319 20161128*/
#ifdef CONFIG_ZFG_AW87319_PA  
	const char *ext_pa = "awinic,ext_pa_spk_aw87319_rst";
#else
