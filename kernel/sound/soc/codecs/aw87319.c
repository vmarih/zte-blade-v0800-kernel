...
static void aw87319_pa_pwron(void)
{
	...
	if (!IS_ERR_OR_NULL(aw87319_rst_low) && !IS_ERR_OR_NULL(aw87319ctrl)) {
		ret = pinctrl_select_state(aw87319ctrl, aw87319_rst_low);
		if (ret) {
	...
	if (!IS_ERR_OR_NULL(aw87319_rst_high) && !IS_ERR_OR_NULL(aw87319ctrl)) {
		ret = pinctrl_select_state(aw87319ctrl, aw87319_rst_high);
		if (ret) {
